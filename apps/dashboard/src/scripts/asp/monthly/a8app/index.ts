import { A8AppDailyScraper } from '../../daily/a8app/index';

/**
 * A8.net App 月次スクレイパー (過去データ一括取得用)
 *
 * 使い方:
 * pnpm exec tsx src/scripts/asp/monthly/a8app/index.ts
 *
 * 環境変数:
 * - A8APP_USERNAME
 * - A8APP_PASSWORD
...
async function main() {
  ...
  for (const month of months) {
    ...
    const scraper = new A8AppDailyScraper(credentials, { ...config, month });
