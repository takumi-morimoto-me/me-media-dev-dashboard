...
> **現在のステータス**: 未実装
>
> このドキュメントは、AIエージェント（MCP）の将来的な実装を検討する際の参考資料として保管されています。
>
> **現在の実装方針**: TypeScript/Playwrightベースの個別ASPスクレイパーを使用しています。
> - 詳細: [ASPスクレイパー概要](../04_development/scrapers.md)
> - 実装ガイド: [スクレイパー実装ガイド](../04_development/scraper-implementation-guide.md)
>
> **最終更新日**: 2025-11-04
